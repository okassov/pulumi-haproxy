    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (_packageRef === undefined) {
            ...
            if (_packageRef === undefined) {
                ...
                params.setName("haproxy");
                params.setVersion("0.0.7");
                params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3NlcGVocmltYW5pYW4vaGFwcm94eSIsInZlcnNpb24iOiIwLjAuNyJ9fQ=="), c => c.charCodeAt(0)));
